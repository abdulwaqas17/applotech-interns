...
//             { id: 'shop-right', title: 'Shop Right Sidebar', url: '/shop?opt=right-sidebar' },
...
//           submenu: [
//             { id: 'product-variable', title: 'Product Variable', url: '/product/basic-colored-sweatpants' },
//             { id: 'product-default', title: 'Product Default', url: '/product/basic-high-neck-puff-jacket' },
...
//             <Link href="/shop" className="font-semibold underline hover:text-primary">
//               SHOP NOW
//             </Link>
//           </p>
//         </div>
...
//                       <Link href={item.url} className="flex items-center px-3 py-2 hover:text-primary">
//                         {item.title}
//                         {item.submenu && <FiChevronDown className="ml-1" size={16} />}
//                       </Link>
...
//                                   <p className="px-4 py-2 font-medium text-gray-800">{subItem.title}</p>
//                                   {subItem.submenu && subItem.submenu.map((child) => (
//                                     <Link 
//                                       key={child.id}
//                                       href={child.url} 
...
//               {/* Wishlist */}
//               <Link href="/wishlist" className="p-2 relative hover:text-primary">
//                 <FiHeart size={20} />
...
//                             <FiChevronDown 
//                               className={`transition-transform ${activeSubmenu === item.id ? 'transform rotate-180' : ''}`} 
//                               size={16} 
//                             />
//                           </button>
...
//                                   ) : (
//                                     <>
//                                       <p className="py-2 px-3 font-medium">{subItem.title}</p>
//                                       {subItem.submenu && (
